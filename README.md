...
2. Add "Demenkovets" to your repository as collaborators - [help](https://help.github.com/en/articles/inviting-collaborators-to-a-personal-repository). 
3. Complete a task.
4. Upload a task file to your repository - [help](https://help.github.com/en/articles/editing-files-in-your-repository).
5. Send an email to Aliaksandr_Rykau@epam.com with a link to your repository (add Mariia_Lukhverchik@epam.com in cc):
